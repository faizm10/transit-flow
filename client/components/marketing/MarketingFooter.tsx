  ...
  return (
    <footer className="border-t border-[var(--landing-border)] bg-[var(--landing-band)]">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-5 py-5 lg:px-8">
        <span className="font-[family-name:var(--landing-mono)] text-[0.6875rem] uppercase tracking-[0.1em] text-[var(--landing-faint)]">
          / TransitFlow <span className="text-[var(--landing-accent)]">/</span> a what-if sandbox for GO Transit
        </span>
        ...
        <div className="flex items-center gap-5">
          ...
          <a
            ...
            rel="noopener noreferrer"
            aria-label="GitHub"
            className="text-[var(--landing-muted)] transition-colors hover:text-[var(--landing-ink)]"
          >
            <GitHubIcon />
          </a>
