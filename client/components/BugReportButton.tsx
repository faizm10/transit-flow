  ...
  return (
    <>
      {variant === "float" ? (
        ...
        <button
          onClick={() => setOpen(true)}
          className="flex items-center gap-1.5 font-[family-name:var(--landing-mono)] text-[0.6875rem] uppercase tracking-[0.1em] text-[var(--landing-muted)] transition-colors hover:text-[var(--landing-ink)] outline-offset-2 focus-visible:ring-2 focus-visible:ring-[var(--landing-accent)]"
        >
